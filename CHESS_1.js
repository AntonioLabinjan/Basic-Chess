// NISU IMPLEMENTIRANE MOGUĆNOSTI KOJE UPOZORAVAJU IGRAČA DA NE SMI POMAKNUT KRALJA NA POLJE DI ĆE BIT U ŠAH-MATU

// UBACUJEMO SLIKE U IGRU
...
//Bojamo šahovsko polje tako da je naizmjenično crno-bijelo
...
//Ovaj dio koda omogućava da polje oko odabrane figure bude druge boje ako je moremo napas/pojis
...
blackCastleChance=true
 ...
 // Provjerava sva polja koja postoje. Dali su slobodna i dali ta figurica koju smo odabrali more doć na njega
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        // Funkcija koja prikazuje sve moguće rute kretanja za figurice
        ...
        // Pratimo ki je na redu

        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "Bijeli igrač je na redu"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Crni igrač je na redu"
            whosTurn('B')
        }
        ...
        if (numOfKings == 1) {
            setTimeout(() => {
                if (tog % 2 == 0) {
                    alert('Bijeli igrač je pobijedio !!!')
                    location.reload()
                }
                else if (tog % 2 !== 0) {
                    alert('Crni igrač je pobijedio !!!')
                    location.reload()
                }
            }, 100)
        }
...
// Osigurava da mičemo samo 1 figuricu istovremeno
z = 0
